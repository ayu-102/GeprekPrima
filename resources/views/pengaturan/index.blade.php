    ...
    <div class="container py-4">
        ...
        @if ($errors->any())
            <div class="alert alert-danger border-0 shadow-sm" style="border-radius: 12px;">
                <i class="bi bi-exclamation-triangle-fill me-2"></i> Periksa kembali data yang Anda masukkan.
            </div>
        @endif
                    ...
                    <form action="{{ route('pengaturan.update') }}" method="POST">
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="text" name="name"
                                    ...
                                    value="{{ old('name', $user->name) }}" style="border-radius: 10px; padding: 12px;">
                                @error('name')
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="email" name="email"
                                    ...
                                    value="{{ old('email', $user->email) }}" style="border-radius: 10px; padding: 12px;">
                                @error('email')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="password" name="password"
                                    ...
                                    placeholder="Isi jika ingin ganti" style="border-radius: 10px; padding: 12px;">
                                @error('password')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                        ...
                        <div class="mt-4">
                            <button type="submit" class="btn text-white w-100 py-3 fw-bold"
                                style="background: linear-gradient(45deg, #FF6500, #C40C0C); border-radius: 12px; border: none;">
            ...
            <div class="col-lg-4">
                <div class="card border-0 shadow-sm p-4 text-center" style="border-radius: 20px;">
                    <div class="position-relative d-inline-block mx-auto mb-3">
                        <div
                            style="width: 100px; height: 100px; background: #f8f9fa; border-radius: 50%; display: flex; align-items: center; justify-content: center; border: 3px solid #eee;">
                    ...
                    <button class="btn btn-outline-danger w-100 border-0 py-2"
